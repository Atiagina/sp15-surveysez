<?php
/**
 * index.php along with demo_view_pager.php provides a sample web application
 *
...
<p>This page, along with <b>survey_view.php</b>, demonstrate a List/View web application for SurveySez.</p>
<p>There will be more surveys soon...</p>
<?php
...
{#records exist - process
	...
	echo '<tr> <th>Date Created</th> <th>Title</th> <th>Description</th> <th>Creator</th> </tr>';
	echo '<tr> <td> ' . dbOut($row['DateAdded']) . ' </td> <td> <a href="' . VIRTUAL_PATH . 'surveys/survey_view.php?id=' . (int)$row['SurveyID'] . '">' . dbOut($row['Title']) . '</a></td> <td>' . dbOut($row['Description']) . '</td> <td> ' . dbOut($row['AdminName']) . '</td> </tr>';
